sap.ui.define([
		...
		// run OPA tests for the current ennvironment (D3 = OpenUI5, MicroCharts = SAPUI5)
				...
				assertions: {
					...
					iShouldSeeTheCharts: function () {
						if (sChartViewName.search("D3") >= 0) {
							this.waitFor({
								controlType: "com/sunshine.control.D3PieChart",
								viewName: sChartViewName,
							...
							this.waitFor({
								controlType: "com/sunshine.control.D3ColumnChart",
								viewName: sChartViewName,
								success: function (aCharts) {
							...
							this.waitFor({
								controlType: ".control.D3ComparisonChart",
								viewName: sChartViewName,
								success: function (aCharts) {
							...
							this.waitFor({
								controlType: "com/sunshine.control.D3Chart",
								viewName: sChartViewName,
								success: function (aCharts) {
